        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Como cada verano sin poder faltar, anunciamos el pirata galiza, uno de los mejores
              festivales que se puede presentar en la comunidad gallega, donde diversion nunca
              va a faltar.
            </p>
            <Link
              to="/login"
        ...
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div className="mt-4 md:mt-0">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
              El parque de castrelos trae al artista Melendi
            </h2>
            <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
              Tras varios años desde su visita a la ciudad viguesa, Melendi vuelve con el
              liston bastante alto. La ciudad ya espera el dia para disfrutar del cantante español.
            </p>
            <Link
              to="/register"
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h2 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
              Aplicacion Eventos Movil
            </h2>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Proximamente traeremos una futura aplicacion en la que podreis seguir explorando y buscando los mejores
              eventos de toda españa
            </p>
            <Link
              to="#"
